...
console.log("-----------------------------");
console.log("Apples\t\t$2,50");
console.log("Bananas\t\t$1.30");
console.log("Oranges\t\t$3.00");
console.log("Grapes\t\t$4.75");
console.log("-----------------------------");
console.log("Total Price: $11.55");
console.log("-----------------------------");
...
Expected Output:
File Path: C:\Users\JohnDoe\Documents\"My Files"\Report.txt
Size: 1.5 MB
...
console.log("Last Modified: 12/22/2024");
console.log("---------------------------");
...
console.log("Rating: 9.5/10");
console.log("Review: \"A mind-bending thriller that explores the concept of dreams within dreams. A must-watch for sci-fi lovers!");
console.log("--------------------------");
